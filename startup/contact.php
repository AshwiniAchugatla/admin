    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="index.php" class="navbar-brand p-0">
                <h1 class="m-0"><img src="img/vishakatextlogo.jpg" width=6%></i>Vishaka Industries</h1>
            </a>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            ...
                            <h6 class="text-primary mb-0">+91 217 2656377</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Email to get free products</h5>
                            <h6 class="text-primary mb-0">info@vishakatex.com</h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            ...
                            <h6 class="text-primary mb-0">D-7/2,MIDC,Akkalkot Road,Solapur-413 006,Maharashtra,India</h6>
                        </div>
                    </div>
                </div>
            </div>
